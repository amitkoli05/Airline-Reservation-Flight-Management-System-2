...
UI UPDATE (Sep 25, 2026)
- Flight Board rows are clickable and open a professional Flight Details modal.
- Flight Details includes route, schedule, aircraft, gate, status, passenger board, and cabin seat map.
- Clicking a booked seat shows the passenger, PNR, class, check-in and booking status.
- Clicking an available seat shows that it is currently unbooked.
- Passenger rows are clickable for the same passenger detail view.
- Search result flight cards are also clickable to open the flight details view.
